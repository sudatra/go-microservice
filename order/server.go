...
import (
	...
	account "github.com/sudatra/go-microservice/account"
	catalog "github.com/sudatra/go-microservice/catalog"
...
func (s *grpcServer) GetOrdersForAccount(ctx context.Context, r *pb.GetOrdersForAccountRequest) (*pb.GetOrdersForAccountResponse, error) {
	...
	if err != nil {
		log.Println("error getting account order products", err)
